// Using every() create a function that is checking if all 
...
function isEveryEmplEngineer(arr) {
    return arr.every(employer => employer.isEngineer)
}

console.log(isEveryEmplEngineer(employees))