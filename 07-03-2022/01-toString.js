// toString()
// Create a function that is receiving a collection of employees and using toString()
...
// Version with reduce(()=>{},[]);
function fullNameString(arr) {
let fullNameString = arr.reduce((newArr, fullName) => {
    fullName = fullName.firstName + " " + fullName.lastName;
    newArr.push(fullName);
    return newArr;
}, []);
fullNameString = fullNameString.toString();
return fullNameString;
}

console.log(fullNameString(employees))
