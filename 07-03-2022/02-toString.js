// Create a function that is receiving a collection of employees and 
// using toString() returns a string with comma-separated    
...
function comSepEmailAndSalary(array) {
    let arr = array.reduce((newArr, info) => {
        newArr.push([info.email] + ': ' + info.salary);
        return newArr;
    }, []).toString();
    return arr;
}
console.log(comSepEmailAndSalary(employees));