// Create a function that is receiving a collection of employees 
...
function joinEmailsToString(arr) {
    let emailArr = [];
    for (let items of arr) {
emailArr.push(items.email);
    }
    return emailArr.join("//");
}

console.log(joinEmailsToString(employees))
