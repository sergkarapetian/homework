...
let n = 7.00
function emplesWithGreaterSlry(arr, n) {
    let result = arr.filter(function (employers) {
        let salary = +(employers.salary.substring(1));
        if (salary > n) {
            return salary;
        }
    })
...
console.log(emplesWithGreaterSlry(employees, n))