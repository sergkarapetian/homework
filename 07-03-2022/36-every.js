// Using every() create a function that is checking if all employees
// have a salary of more than n
...
function checkSalary(arr, n) {
    return arr.every(employer => Number(employer.salary.slice(1)) > n);
}
console.log(checkSalary(employees, n));
