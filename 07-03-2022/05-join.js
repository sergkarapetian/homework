// Create a function that is receiving a collection
//  of employees and returns a string with comma-separated email: salary 
...
function collectEmailsAndSalarys(arr) {
        let array = arr.reduce((newArr, info) => {
            newArr.push([info.email] + ': ' + info.salary);
            return newArr;
        }, []).join(", ");
        return array;
    }

console.log(collectEmailsAndSalarys(employees));