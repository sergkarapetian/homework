...
// to sort the collection of employees by their name 
...
function employeesNameList(arr) {
    return arr.sort(function (currentCollection, nextCollection) {
        if(currentCollection.firstName > nextCollection.firstName) return 1;
    if (currentCollection.firstName == nextCollection.firstName) return 0;
    if (currentCollection.firstName < nextCollection.firstName) return -1;
})
}
console.log(employeesNameList(employees))
