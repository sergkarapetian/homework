// Using reduce create a function that is receiving a collection of
//  employees and returns a string containing emails in the following format 
...
function emailString(arr) {
    let result = arr.reduce(function (array, employer) {
        array.push(employer.email+"//");
        return array
    }, [])
    return result.toString();
}

console.log(emailString(employees));