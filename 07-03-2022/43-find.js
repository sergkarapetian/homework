...
function findEmployer(arr, obj) {
    let result = arr.find(employer => 
        (employer["firstName"] === obj.firstName) && (employer["lastName"] === obj.lastName)
    )
    console.log(result);
}

findEmployer(employees, { firstName: `Flemming`, lastName: `Scroggins` })
